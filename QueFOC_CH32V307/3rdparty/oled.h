...
#define OLED_SDIN_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_7)    //  SCL
...
void IIC_Wait_Ack();
void OLED_Display_CH(void);
void OLED_Display_DIS(float Dis, float S_Dis);
void OLED_Display_Speed(float value);
void OLED_Display_TH(unsigned int H,unsigned int T,unsigned int SH,unsigned int ST);
#endif  
